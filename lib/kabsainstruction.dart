...
class Kabsains extends StatelessWidget {
  Future<List<String>> fetchInstructions() async {
    final doc = await FirebaseFirestore.instance
        ...
        .get();
    final data = doc.data();
    if (data != null && data.containsKey('instructions')) {
        ...
        child: FutureBuilder<List<String>>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError) {
              return Center(child: Text('Error fetching instructions.'));
            }
      ...
      children: [
        ...
        Positioned(
          ...
          child: IconButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Kabsaing()));
            },
          ),
        ),
        Positioned(
