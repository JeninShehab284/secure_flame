...
import 'package:secureflame/kabsainstruction.dart';
import 'recipes.dart';
...
class Kabsaing extends StatelessWidget {
  final FirebaseFirestore firestore = FirebaseFirestore.instance;

  Stream<DocumentSnapshot> getIngredients() {
    return firestore.collection('recipes').doc('kabsa').snapshots();
  }
      ...
      body: SafeArea(
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            var ingredients = List<String>.from(recipe['ingredients'] ?? []);
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('images/kabsaa.jpg'),
                          fit: BoxFit.cover,
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => Kabsains()),
                          );
                        },
                        child: Text(
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          final Uri youtubeUrl = Uri.parse(
                              'https://www.youtube.com/watch?v=R-uWil9xGBs&t=4s');
